...
export default function JoinVivik() {
  const whatsappLink = "https://chat.whatsapp.com/FYgOTt63mb9D5hrXV7rR1c";

  // Only run this after the component is mounted (client-side)
    ...
    <>
      <main className="min-h-screen flex flex-col items-center justify-center px-0 py-0 bg-white">
        ...
        <div className="flex flex-col items-center justify-center text-center p-8 max-w-2xl">
          <h2 className="text-2xl font-semibold mb-4">Done submitting?</h2>
          <p className="text-lg mb-6">Join VIVIK&apos;s WhatsApp community now!</p>
          <Link
            href={whatsappLink}
            target="_blank"
            rel="noopener noreferrer"
            className="bg-green-500 hover:bg-green-600 text-white font-bold py-4 px-8 rounded-full text-xl flex items-center transition-all"
          >
